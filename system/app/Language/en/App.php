...
return [
    ...
    "site_menu_contact" => "Contact",
    "site_menu_pricing" => "Pricing",
    "site_menu_faq" => "FAQ",
    "site_menu_blog" => "Blog",
    "site_menu_blog_home" => "Blog Home",
    "site_menu_blog_post" => "Blog Post",
    "site_menu_portfolio" => "Portfolio",
    "site_menu_portfolio_overview" => "Portfolio Overview",
    "site_menu_portfolio_item" => "Portfolio Item",
    "site_menu_btn_login" => "Login",
    "site_menu_btn_dashboard" => "Dashboard",
    "direction" => "ltr",
];
