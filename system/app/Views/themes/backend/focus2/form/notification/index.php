                        ...
                        <div class="table-responsive">
                            <table id='table-grid' class="table table-striped nowrap" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th><?=lang("App.notification_grid_sms")?></th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let columns = [{ data: 'sender' },{ data: 'recipient' },{ data: 'title' },{ data: 'is_send_email' },{ data: 'is_send_sms' },{ data: 'is_read' },{ data: 'created_at' },{ data: 'options' }];
